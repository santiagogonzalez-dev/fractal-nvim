...
vim.keymap.set('n', '<Leader>cb', utils.blink_crosshair, { desc = 'Blink the cursor crosshair' })
...
vim.keymap.set(
   'n',
   '<Leader>tc',
   function() vim.opt_local.conceallevel = vim.opt_local.conceallevel:get() == 2 and 0 or 2 end
)
