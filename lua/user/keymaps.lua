...
vim.keymap.set(
  ...
  { desc = 'Impatient.nvim: Clear cache' }
)
...
vim.keymap.set(
  ...
  'n',
  '"Nn"[v:searchforward]',
  { expr = true, desc = 'n is always next' }
)
vim.keymap.set(
  { 'n', 'x', 'o' },
  'N',
  '"nN"[v:searchforward]',
  { expr = true, desc = 'N is always previous' }
)
...
vim.keymap.set(
  ...
  '<A-j>',
  ':m .+1<CR>==',
  { desc = 'Move current block of text up and down', silent = true }
) -- Normal mode
vim.keymap.set(
  'n',
  '<A-k>',
...
vim.keymap.set(
  ...
  '<A-j>',
  ":m '>+1<CR>gv=gv",
  { desc = 'Move block of text up and down', silent = true }
) -- Visual mode
vim.keymap.set(
  { 'v', 'x' },
  '<A-k>',
...
vim.keymap.set(
  ...
  { desc = 'Silence this keybind', silent = true }
)
vim.keymap.set(
  'n',
  'zc',
  '<CMD>silent! foldclose<CR>',
  { desc = 'Silence this keybind', silent = true }
)
...
vim.keymap.set(
  ...
  '<',
  '<gv',
  { desc = 'Keep visual selection after shifting code block' }
)
vim.keymap.set(
  { 'v', 'x' },
  '>',
