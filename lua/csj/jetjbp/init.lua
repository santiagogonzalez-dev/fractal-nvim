...
function jet.setup()
   ...
   jet.h('TSKeywordFunction', { fg = jet.jbp.purple0 }) -- Keywords used to define a function: `function` in Lua, `def` and `lambda` in Python.
   ...
   jet.h('Comment', { fg = jet.jbp.dimmed3 })
