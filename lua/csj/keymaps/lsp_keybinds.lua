...
set('n', 'gll', function()
    return require('csj.utils').not_interfere_on_float(vim.diagnostic.open_float)
end)

set('n', 'gl', function()
    return require('csj.utils').not_interfere_on_float(vim.lsp.buf.hover)
end)
...
set('n', '<Leader>ld', require('csj.utils').toggle_diagnostics) -- Toggle diagnostics
set('n', 'r', require('csj.utils').rename) -- Rename
