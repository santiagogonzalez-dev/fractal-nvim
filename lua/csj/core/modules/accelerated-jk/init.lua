...
local driver = require('csj.core.modules.accelerated-jk.time_driven'):new(config)
...
vim.keymap.set('n', 'j', function()
  require('csj.core.modules.accelerated-jk').move_to('j')
end)
vim.keymap.set('n', 'k', function()
  require('csj.core.modules.accelerated-jk').move_to('k')
end)
