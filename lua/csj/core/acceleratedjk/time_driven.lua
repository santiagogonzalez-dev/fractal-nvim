local acceleration = {} -- time driven acceleration

function acceleration:new(config)
  local o = {
    key_count = 0,
    previous_timestamp = {
      j = { 0, 0 },
...
function acceleration:decelerate(delay)
...
function acceleration:move_to(movement)
