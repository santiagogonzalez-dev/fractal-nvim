...
function MiniIndentscope.setup(config)
  ...
  local indentscopegroup = vim.api.nvim_create_augroup('_indentscope', {})

  -- Module behavior
  vim.api.nvim_create_autocmd({ 'CursorMoved', 'CursorMovedI' }, {
    group = indentscopegroup,
    callback = function()
      return MiniIndentscope.auto_draw { lazy = true }
    end,
  })
  ...
  vim.api.nvim_create_autocmd({ 'TextChanged', 'TextChangedI', 'TextChangedP', 'WinScrolled' }, {
    group = indentscopegroup,
    callback = function()
      return MiniIndentscope.auto_draw()
    end,
  })
  ...
  -- Create highlighting
  vim.cmd([[hi default link MiniIndentscopeSymbol Delimiter
